    ...
    <div className="home">
      <div className="home_container">
        ...
        <div className="home_row">
          ...
          <Product
            ...
            title="Kenwood mix Stand Mixer for baking, Stylish Kitchen Mixer with K-beater,
                        Dough hook and whisks, 5 Litre Glass Bowl"
            price={239.0}
        ...
        <div className="home_row">
          <Product
            id="12345671"
            title="Samsung LC494RG90SSUXEN 49' Curved LED Gaming Monitor"
            price={199.99}
          ...
          <Product
            id="12345672"
            title="Amazon Echo (3rd generation) | Smartt speaker with Alexa, Charcoal Fabric"
            price={98.99}
